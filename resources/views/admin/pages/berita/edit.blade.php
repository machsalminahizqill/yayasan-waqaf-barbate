...
@section('content')
    <main class="leftright">
        <div id="form" class="mt-8">
            <form action="{{ route('editBeritaAdmin') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="judul" id="judul" name="judul" value="{{ $berita->judul }}"
                ...
                <div class="mb-6">
                    ...
                    <textarea id="myeditorinstance" name="konten">{{ $berita->konten }}</textarea>
                </div>
                <div class="mb-6">
                ...
                <div class="flex gap-2">
                    <a href="/admin/berita/{{ $berita->slug }}/{{ $berita->id }}" class="px-6 py-1 bg-slate-600 hover:bg-slate-700 rounded-md text-white">Kembali</a>
                    <button type="submit"
